...
class Client extends protocol_js_1.Protocol {
    ...
    async callTool(params, resultSchema = types_js_1.CallToolResultSchema, options, headers) {
        return this.request({ method: "tools/call", params, headers }, resultSchema, options);
    }
